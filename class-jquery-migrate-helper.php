...
class jQuery_Migrate_Helper {
	...
	public static function admin_settings() {
	    ...
	    $previous_downgrade = get_option( '_jquery_migrate_downgrade_version', 'yes' );
	...
	public static function site_health_test() {
		...
		$downgrade_state = get_option( '_jquery_migrate_downgrade_version', 'yes' );
	...
	public static function replace_scripts( $scripts ) {
		...
		if ( version_compare( $GLOBALS['wp_version'], '5.6-alpha', '<' ) || 'yes' === get_option( '_jquery_migrate_downgrade_version', 'yes' ) ) {
